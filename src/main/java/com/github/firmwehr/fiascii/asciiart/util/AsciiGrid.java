...
public class AsciiGrid {
	...
	public Optional<Point> findInColumn(
		Point start, char needle, VerticalDirection direction) {
	...
	public Optional<Point> findInRow(
		Point start, char needle, HorizontalDirection direction) {
