...
public record AsciiBox(
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(topLeft, asciiBox.topLeft) && Objects.equals(bottomRight,
			asciiBox.bottomRight);
	}
	...
	public String toString() {
		return "AsciiBox{" + "lines=" + lines + ", ins=" + ins.stream().map(c -> c.start().location())
			.toList() +
